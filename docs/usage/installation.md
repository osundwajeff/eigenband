...
This plugin is published on the official QGIS plugins repository: <https://plugins.qgis.org/plugins/eigenband/>.### Using this plugin with QGIS Deployment Toolbelt (QDT)
...
```url
https://github.com/osundwajeff/eigenband/pages/plugins.xml
```
