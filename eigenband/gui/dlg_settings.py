...
# project
from eigenband.__about__ import (
    __icon_path__,
    __title__,
    __uri_homepage__,
    __uri_tracker__,
...
from eigenband.toolbelt import PlgLogger, PlgOptionsManager
from eigenband.toolbelt.preferences import PlgSettingsStructure
